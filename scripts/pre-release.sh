...
readonly PYTHON_PATHS=(constants db mgr tests web)
readonly PYTHON_FILES=(constants/*.py db/*.py mgr/*.py tests/*.py web/*.py)
...
main() {
    ...
    run_check "Checking for security issues" bandit -r constants db mgr web
